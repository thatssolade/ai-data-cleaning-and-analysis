...
- `data.md`: Contains raw multi-country source data and the prompt-cleaned Nigeria subset (_Google Sheets link to Tracking Acute Food Insecurity & Crisis Projections in Nigeria (2015–2026).csv_).
